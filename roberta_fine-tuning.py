...
def train(args, model, tokenizer):
    ...
    unqover_train, _, _, _, _, _, _  = mt.get_data(os.path.join(args.data_dir, f'addedbias_train_{args.num_train}_squad.json'), tokenizer, count=-1,  replace2token=args.replace2token)
