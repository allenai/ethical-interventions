...
do
   ...
   python3 roberta_fine-tuning.py  --data_dir $DATADIR/${att}/iid  --model_type  robertaall  --model_name_or_path $OUTPUT_PATH   --output_dir $dir  --category ${att}  --learning_rate 1e-5  --overwrite_output_dir  --num_train $NUM_TRAIN --per_gpu_train_batch_size $BATCH_SIZE  --eval --eval_all_checkpoints
