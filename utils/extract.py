...
def tokenize_underspecified_input(tokenizer, source, verbose=False):
	rs = []
	cnt = 0
	for scluster, spair, tid, acluster, opair, context, choices, questions, intv_id in source:
		...
		rs.append((scluster, spair, tid, acluster, opair, context_toks, choice_spans, question_toks, intv_id))
